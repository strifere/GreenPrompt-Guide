...
type AdminDatasetDeleteActionProps = {
  datasetName: string;
};

export function AdminDatasetDeleteAction({ datasetName }: Readonly<AdminDatasetDeleteActionProps>) {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/datasets/${encodeURIComponent(datasetName)}`, {
        method: "DELETE",
      });
      ...
      {open ? (
        <div className="recovery-modal-overlay">
          <button
            ...
            aria-label="Close delete dataset dialog"
            onClick={closeDialog}
          />
          <div className="recovery-modal">
            ...
            <p className={styles.dialogHint}>
              This will permanently remove &quot;{datasetName}&quot; from the system.
            </p>
