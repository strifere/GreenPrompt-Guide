...
type AdminModelDeleteActionProps = {
  modelName: string;
};

export function AdminModelDeleteAction({ modelName }: Readonly<AdminModelDeleteActionProps>) {
        ...
        <div className="recovery-modal-overlay">
          ...
          <div className="recovery-modal">
            ...
            <p className={styles.dialogHint}>
              This will permanently remove &quot;{modelName}&quot; from the system.
            </p>
