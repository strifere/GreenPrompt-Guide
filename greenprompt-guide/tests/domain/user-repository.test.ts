...
describe("user-repository", () => {
  ...
  describe("User Lookup", () => {
    it("should get user by username", async () => {
      const findUniqueMock = prisma.user.findUnique as Mock;
    ...
    it("should get user email by username", async () => {
      ...
      it("should get user by identifier (username)", async () => {
        const findFirstMock = prisma.user.findFirst as Mock;
      ...
      it("should list users", async () => {
        const findManyMock = prisma.user.findMany as Mock;
  ...
  describe("User Creation", () => {
    it("should create a user", async () => {
      const createMock = prisma.user.create as Mock;
  ...
  describe("User Deletion", () => {
    it("should delete a user by username", async () => {
        const deleteMock = prisma.user.delete as Mock;
  ...
  describe("User Updates", () => {
    it("should update user ban status", async () => {
        const updateMock = prisma.user.update as Mock;
